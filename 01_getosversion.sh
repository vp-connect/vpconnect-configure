...
#   Запишет env-файл, хук в /etc/profile.d (login-shell) и одну помеченную секцию в ~/.bashrc
#   (маркер общий с 05/06/07/08 --persist; повторный --persist не дублирует блок).
